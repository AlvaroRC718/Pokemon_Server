            ...
            if ($rival_pokemon['current_ps'] == 0) { //En caso de que el rival se ha debilitado paso al siguiente
                if (count($rival_team) == 1 && $battle_state) { //No le quedan pokemon
                    ...
                    if (isset($_POST["player2_name"])) { //Solo existe en pvp
                        $message_log = "El entrenador " . htmlspecialchars($_POST["player1_name"]) . " gano al entrenador " .  htmlspecialchars($_POST["player2_name"]) . ".</br> Debes pulsar (Salir) para seleccionar un nuevo combate.";
                    } else {
                        $message_log = "El entrenador " .  htmlspecialchars($_POST["player1_name"]) . " gano al entrenador calvo Fran.</br> Debes pulsar (Salir) para seleccionar un nuevo combate.";
                    }
                } else {
                ...
                if (count($your_team) == 1 && $battle_state) { //No te quedan pokemon
                    $battle_state = false;
                    if (isset($_POST["player2_name"])) { //Solo existe en pvp
                        $message_log = "El entrenador " .  htmlspecialchars($_POST["player2_name"]) . " gano al entrenador " .  htmlspecialchars($_POST["player1_name"]) . ".</br> Debes pulsar (Salir) para seleccionar un nuevo combate.";
                    } else {
                        $message_log = "El entrenador calvo Fran gano al entrenador " .  htmlspecialchars($_POST["player1_name"]) . ".</br> Debes pulsar (Salir) para seleccionar un nuevo combate.";
                    }
                }
