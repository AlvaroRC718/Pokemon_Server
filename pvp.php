    ...
    <div class="container">
        <form action="fight.php" method="post">
            <div class="players-sections">
                ...
                <section class="twoplayer">
                    <h2 class="blueh2">Selecciona tu equipo Pokémon Jugador 1:</h2>
                    ...
                    <input type="text" name="player1_name" id="player1_name" class="select-input-team" /><br />
                    <?php
                    for ($i = 1; $i < 7; $i++) {
                ...
                <section class="twoplayer">
                    <h2 class="blueh2">Selecciona tu equipo Pokémon Jugador 2:</h2>

                    <label for="player2_name" class="blue">Introduce tu nombre:</label>
                    <img src='resources/blue.gif' alt='entrenador2' width='80px' height='80px' />
                    <input type="text" name="player2_name" id="player2_name" class="select-input-team" required /><br />
                    <?php
                    for ($i = 1; $i < 7; $i++) {
                        echo "<img src='resources/pokeball2.png' alt='pokeball' width='20px' height='20px'/>";
                        echo "<label for='teams[$i]' class='blue'> " . $i . "º Pokemon</label>";
